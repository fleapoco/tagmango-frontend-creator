...
export const CalendarTask = () => {
  ...
  // const handleTaskChipClick = (task: GetTask) => {
  //   // Add your logic for handling chip button click
  //   console.log(`Task "${task.title}" clicked at ${task.startTime}`);
  // };
          ...
          <div key={task.id} style={{ marginBottom: 8 }}>
            ...
            {dayjs(task.startDate).isSame(value, "day") && (
              <Space>
                <CustomTag
                  variant={
                    task.status === TaskStatus.COMPLETED ? "success" : "gray"
                  }
